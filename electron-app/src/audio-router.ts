...
export class AudioRouter extends EventEmitter {
    ...
    private inputDeviceId: number | null = null;
    private outputDeviceId: number | null = null;
    private isRunning = false;

    constructor() {
        super();
        const devices = findVBCableDevices();
        this.inputDeviceId = devices.inputId;
        this.outputDeviceId = devices.outputId;
    }

    get isReady(): boolean {
        return this.inputDeviceId !== null && this.outputDeviceId !== null;
    }
